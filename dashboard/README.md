...
We use a dataset about the population of Zürich. The dataset can be downloaded --> [her](https://data.stadt-zuerich.ch/dataset/bev_monat_bestand_quartier_geschl_ag_herkunft_od3250).    
In this example, we have three filters (district aka Kreis, year and semester).  
